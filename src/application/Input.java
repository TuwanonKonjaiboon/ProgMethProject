...
public class Input {
    ...
    private KeyCode attack1Key = KeyCode.Z;
    private KeyCode attack2Key = KeyCode.X;
    ...
    public boolean isAttack1() {
    	return keyboardBitSet.get( attack1Key.ordinal()) && !keyboardBitSet.get( attack2Key.ordinal());
    }
    
    public boolean isAttack2() {
    	return keyboardBitSet.get( attack2Key.ordinal()) && !keyboardBitSet.get( attack1Key.ordinal());
    }
